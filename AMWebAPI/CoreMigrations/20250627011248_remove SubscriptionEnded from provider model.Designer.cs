...
namespace AMWebAPI.CoreMigrations
{
    ...
    [Migration("20250627011248_remove SubscriptionEnded from provider model")]
    partial class removeSubscriptionEndedfromprovidermodel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMData.Models.CoreModels.ProviderAlertModel", b =>
                {
                    b.Property<long>("ProviderAlertId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ProviderAlertId"));
                    ...
                    b.Property<DateTime>("AlertAfterDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("ProviderAlertId");

                    b.HasIndex("ProviderId");

                    b.ToTable("ProviderAlert");
                });
            ...
            modelBuilder.Entity("AMData.Models.CoreModels.ProviderLogPayment", b =>
                {
                    b.Property<long>("ProviderLogPaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ProviderLogPaymentId"));
            ...
            modelBuilder.Entity("AMData.Models.CoreModels.ProviderModel", b =>
                {
                    ...
                    b.Property<string>("ProviderGuid")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ProviderGuid")
                        .IsUnique()
                        .HasFilter("[ProviderGuid] IS NOT NULL");
            ...
            modelBuilder.Entity("AMData.Models.CoreModels.ProviderReviewModel", b =>
                {
                    b.Property<long>("ProviderReviewId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AMData.Models.CoreModels.ProviderModel", b =>
                {
                    ...
                    b.Navigation("ProviderLogPayments");
